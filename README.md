...
### How I like to build
- User experience matters as much as the code  
- Simple, practical solutions over over-engineering  
- Iteration and improvement are part of the process  
- Clean visuals and thoughtful interactions  

### Why I build
I build because I enjoy it. Some projects are hobbies, some turn into freelance work, and others are just experiments to learn something new. I’m especially interested in building tools that solve real problems or make systems easier to use.

### What you’ll find here
- Personal projects and experiments  
- Iterative builds that improve over time  
- Practical web apps, not just one-off demos  
